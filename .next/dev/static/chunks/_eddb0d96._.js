...
function LoginPage() {
    ...
    const { user, login, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    ...
    const [csvError, setCsvError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LoginPage.useEffect": ()=>{
            const loadUsers = {
                "LoginPage.useEffect.loadUsers": async ()=>{
                    try {
                        setLoadingUsers(true);
                        setCsvError("");
                        console.log("[v0] Loading users from CSV...");
                        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$csv$2d$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAllUsers"])();
                        ...
                        setAvailableUsers(users.map({
                            "LoginPage.useEffect.loadUsers": (u)=>({
                                    email: u.email,
                                    name: u.name
                                })
                        }["LoginPage.useEffect.loadUsers"]));
                    } catch (error) {
...
_s(LoginPage, "W9uR02ZS7AM37PuGDSqRujSxEyA=", false, function() {
    return [
...
//# sourceMappingURL=_eddb0d96._.js.map